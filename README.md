...
jobs:
  claude-response:
    ...
    steps:
      - uses: H-K-Libra/claude-code-action@beta  # Fork with OAuth support
        with:
...
This action is built on top of [`H-K-Libra/claude-code-base-action`](https://github.com/H-K-Libra/claude-code-base-action).
