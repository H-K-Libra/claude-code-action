...
## Fork Changes (H-K-Libra/claude-code-action@beta)
...
- **Updated Base Action**: Uses `H-K-Libra/claude-code-base-action@beta` which includes OAuth credential handling
